---
title: "re:SearchGA Docket Printout"
parent: Court Filings
nav_order: 24
layout: default
permalink: /filings/docket-printout/
date: 2026-04-17
filer: "Research artifact"
doc_type: "Docket printout (research artifact)"
---

# re:SearchGA Docket Printout

{: .note }
> **Retrieved** 2026-04-17 · **By** kerry@kerryhatcher.com · **Document type** Docket printout (research artifact)
> **[View the PDF →]({{ site.baseurl }}/pdfs/re_SearchGA-Georgia_Trust_for_Local_News_d_b_a_The_Macon_Melody_vs._The_Bibb_County_School_District_2025-CV-083495.pdf){: .btn .btn-outline }**
...
Access to the **docket** — the list of events — is free. Access to the **actual documents** behind each event usually costs money (see the companion [Purchase Receipt]({{ site.baseurl }}/filings/docket-receipt/) page). That split is the practical reality of "public records" in Georgia: you can almost always see that a thing exists, but reading it can cost you.
