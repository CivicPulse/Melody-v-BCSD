---
title: "BCSD's Motion to Extend Discovery"
parent: Court Filings
nav_order: 21
layout: default
permalink: /filings/discovery-extension-motion/
date: 2026-04-13
filer: "Bibb County School District"
doc_type: "Motion to Extend Discovery"
---
...
| Field | Value |
|-------|-------|
| Filed | April 13, 2026, 2:40 PM |
| Filed by | Caroline L. Scalf and Bennett D. Bryan (Parker Poe), for BCSD |
| Document type | Motion to Extend Discovery |
| Served on | Lucas W. Andrews and Erika Pitzel (Stanton Law LLC), for the Macon Melody |
...
Georgia courts have discretion to extend discovery on a showing of **good cause**. Good cause is not a defined statutory term; it's whatever the trial judge reasonably thinks it is. The standard factors a court weighs include:

- How much discovery has already been completed
- Why it wasn't completed on time
- Whether the moving party has been diligent
- Whether the non-moving party is prejudiced by delay
- Whether the requested extension is proportionate to the remaining work

BCSD's motion papers its showing along each of those axes. It catalogs the discovery already exchanged, points to the still-pending interrogatories (served April 3 and not due until May 3), cites the meet-and-confer history, and frames the extension as modest and necessary rather than abusive.

Whether a court grants the motion usually turns less on the written record than on the judge's instinct about whether the movant is operating in good faith. Here, Judge Smith granted it within a day.

### The "requester knowledge" FERPA theory — what BCSD is building

FERPA — the federal Family Educational Rights and Privacy Act, [20 U.S.C. § 1232g](https://www.law.cornell.edu/uscode/text/20/1232g) (Title 20 of the United States Code — the federal statute book — section 1232g) — bars schools that receive federal funds from releasing "personally identifiable information" (PII) from education records without parental consent. The implementing regulation at **[34 C.F.R. § 99.3](https://www.ecfr.gov/current/title-34/section-99.3)** (Title 34 of the Code of Federal Regulations — where federal rules live — section 99.3) defines PII to include, among other things, "information requested by a person who the educational agency or institution reasonably believes knows the identity of the student to whom the education record relates."

That last clause is the door BCSD is trying to walk through. The district's theory is:

1. The Melody's reporters and sources already know a great deal about the underlying events.
...
A deposition is sworn testimony, transcribed by a court reporter, taken out of court. Deposing a reporter is different from deposing almost any other witness because Georgia, like most states, protects journalists' source material.

**[O.C.G.A. § 24-5-508](https://law.justia.com/codes/georgia/2024/title-24/chapter-5/article-5/section-24-5-508/)** — Georgia's reporter's shield statute — provides that a person engaged in the gathering and dissemination of news "shall have a qualified privilege against disclosure of any information, document, or item obtained or prepared in the gathering or dissemination of news." The privilege can be overcome only if the party seeking disclosure shows, by clear and convincing evidence, that the information is material and relevant, cannot be reasonably obtained by alternative means, and there is a compelling need for the disclosure.

That's a high bar. If BCSD actually attempts to depose [Laura Corley](https://maconmelody.com/author/laura-corley/) and [Casey Choung](https://maconmelody.com/author/caseymaconmelody-com/) about who told them what, the Melody can — and almost certainly will — invoke § 24-5-508. The resulting fight would be briefed on motion to quash or for a protective order. That fight is, itself, a reason BCSD wants more time: these sub-battles can take weeks to resolve.

It's worth noting that the motion frames the reporter depositions matter-of-factly, as if they're a routine next step. They are not routine. A Georgia school district seeking sworn testimony from working local journalists about the identity of their sources is the kind of fight that would draw statewide press attention on its own.

### Ga. CPA § 9-11-56(f) — how this sets up a "not ripe" response to plaintiff's MSJ

Georgia's Civil Practice Act (Ga. CPA — the state court procedure rules), **[O.C.G.A. § 9-11-56(f)](https://law.justia.com/codes/georgia/2024/title-9/chapter-11/article-7/section-9-11-56/)** (section 9-11-56(f)), gives a party opposing summary judgment a way to say: "Not yet — I need discovery to respond." The rule lets the nonmoving party file an affidavit explaining what discovery they still need and why. If the court credits the affidavit, it can deny or continue the summary judgment motion until that discovery is completed.
...
This motion is the strategic centerpiece of the entire defense. Everything BCSD has done procedurally since December 2025 has been designed to create the conditions that make this extension look reasonable, and to stockpile the unfinished discovery that makes a § 9-11-56(f) "not yet" argument plausible at the upcoming summary-judgment hearing.

The public-interest stakes are high in two directions. First, the longer this case takes, the longer a taxpayer-funded settlement amount stays hidden from the voters and parents whose children attend BCSD schools. Second, if the reporter depositions actually happen — and especially if the court compels testimony over a § 24-5-508 objection — the case becomes about more than one settlement. It becomes about whether a Georgia public body can use an Open Records Act lawsuit as a fishing expedition into a newspaper's newsroom.

The court granted the motion the next day. Whether that grant stops at the discovery extension or flows into a successful § 9-11-56(f) deferral on April 29 is the next pivot point.

## Read the original

**[Download the PDF →]({{ site.baseurl }}/pdfs/2026.04.13_BCSD_Motion_to_Extend_Discovery.pdf)**

*Part of [Court Filings]({{ site.baseurl }}/filings/) · Case No. 2025-CV-083495 · Bibb County Superior Court*
