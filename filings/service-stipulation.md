---
title: "Service Waiver Stipulation"
parent: Court Filings
nav_order: 4
layout: default
permalink: /filings/service-stipulation/
date: 2025-08-14
filer: "Joint filing — Joy Ramsingh (Plaintiff) and Caroline L. Scalf (Defendant BCSD)"
doc_type: "Stipulation (Joint Procedural Filing)"
---

# Service Waiver Stipulation

{: .note }
> **Filed** 2025-08-14 · **By** Joy Ramsingh (Plaintiff) and Caroline L. Scalf (Defendant BCSD), jointly · **Document type** Stipulation — waiver of service and extension of answer deadline
> **[View the PDF →]({{ site.baseurl }}/pdfs/Macon_Melody_Stipulation_CLS_edits_JR_edits.pdf){: .btn .btn-outline }**
...
All of those defenses in fact appear in BCSD's later [Original Answer]({{ site.baseurl }}/filings/answer/), filed on the October 13, 2025 deadline this stipulation created. The waiver simply lets BCSD litigate those defenses without ever having to first fight about whether service was technically proper.
...
**[Download the PDF →]({{ site.baseurl }}/pdfs/Macon_Melody_Stipulation_CLS_edits_JR_edits.pdf)**
