...
{: .note }
> **Legal shorthand used here:** *ORA* = Georgia Open Records Act ([O.C.G.A. § 50-18-70](https://law.justia.com/codes/georgia/2024/title-50/chapter-18/article-4/section-50-18-70/) *et seq.*). *ORR* = Open Records Request — the written ask submitted under the ORA. *AG* = Georgia Attorney General's Office. *DOE* = Georgia Department of Education. *BCSD* = Bibb County School District. *FERPA* = Family Educational Rights and Privacy Act. *IDEA* = Individuals with Disabilities Education Act. *PII* = personally identifiable information. *§* = "section"; *et seq.* is Latin for "and following". *F. Supp.* = Federal Supplement (a book of federal trial court decisions). Case citations read: volume / reporter / page / year.
...
> *Primary source:* BCSD meeting minutes, July 18, 2024 — quoted verbatim in the [Complaint]({{ site.baseurl }}/filings/complaint/) (Exhibit E).

---

## 2. Laura Corley's first ORR and AG Letter A (July – October 2024)

On **July 29, 2024** — eleven days after the vote — *Macon Melody* senior accountability reporter [Laura Corley](https://maconmelody.com/author/laura-corley/) filed the newspaper's first Open Records Request seeking records relating to the JH settlement. BCSD refused, citing *Mullins v. City of Griffin*, 886 F. Supp. 21 (N.D. Ga. 1995), as authority for treating the figure as non-public.
...
The AG asked BCSD to (1) defend the [O.C.G.A. § 50-18-72(a)(37)](https://law.justia.com/codes/georgia/2024/title-50/chapter-18/article-4/section-50-18-72/) education-records exemption on the record, (2) produce the July 18, 2024 minutes, and (3) respond within 10 business days.
...
> *Primary source:* [AG Letter A — Opening, Oct. 25, 2024]({{ site.baseurl }}/documents/pre-litigation/ag-letter-opening/).
...
> *Primary sources:* [BCSD Denial Letter to Hatcher (Mar. 14, 2025)]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/); [Parker Poe ORR Cost Schedule]({{ site.baseurl }}/documents/pre-litigation/orr-cost-schedule/); [Hatcher JH Settlement ORR]({{ site.baseurl }}/documents/orr/hatcher-jh-settlement/); [Hatcher Collateral ORRs]({{ site.baseurl }}/documents/orr/hatcher-collateral/).
...
> *Primary source:* [GA DOE Response Letter (Apr. 14, 2025)]({{ site.baseurl }}/documents/pre-litigation/doe-response/).
...
The letter declared the mediation at impasse and pointed the parties to [O.C.G.A. § 50-18-73(a)](https://law.justia.com/codes/georgia/2024/title-50/chapter-18/article-4/section-50-18-73/) — the private-enforcement provision of the Open Records Act. It remained addressed to Jones Cork, despite Jones Cork's January 3 termination.

The April 24 letter is **Exhibit F** to the Melody complaint. AG Letter A (October 25, 2024) is new to this site.

> *Primary source:* [AG Letter B — Close-Out (Apr. 24, 2025)]({{ site.baseurl }}/documents/pre-litigation/ag-letter-closeout/).
...
> *Primary source:* [Complaint]({{ site.baseurl }}/filings/complaint/) (Exhibit B = the denial letter; Exhibit F = AG Letter B).
...
- BCSD's [34 C.F.R. § 99.3](https://www.ecfr.gov/current/title-34/section-99.3) "requester-knowledge" FERPA theory — flagged in this site's [Case Report]({{ site.baseurl }}/docs/case-report/) as a live defense theory — is deployed in writing in the [March 14, 2025 denial letter to Hatcher]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/), citing a specific named requester and his advocacy-site posts as evidence of that requester's identifying knowledge.

Whether these facts support plaintiff's fee-shifting claim under [O.C.G.A. § 50-18-73(b)](https://law.justia.com/codes/georgia/2024/title-50/chapter-18/article-4/section-50-18-73/) or defendant's "substantial justification" defense is the question the court will reach after the merits of the FERPA-vs-ORA dispute are decided at the [April 29, 2026 hearing]({{ site.baseurl }}/filings/notice-of-hearing-reissued/).

---

## See also

- [Case Report]({{ site.baseurl }}/docs/case-report/) — the long-form analytical narrative.
- [Timeline]({{ site.baseurl }}/docs/timeline/) — chronological docket.
- [Pre-Litigation Record]({{ site.baseurl }}/documents/pre-litigation/) — the primary-source documents summarized above.
- [Open Records Requests]({{ site.baseurl }}/documents/orr/) — the civic-parent ORRs that ran parallel to Corley's journalism track.
- [Parties & Counsel]({{ site.baseurl }}/docs/parties/) — the actors named in the pre-litigation record.
