---
title: "Hatcher JH Settlement ORR (Mar. 2025)"
parent: Open Records Requests
grand_parent: Documents
nav_order: 1
layout: default
permalink: /documents/orr/hatcher-jh-settlement/
date: 2025-03-11
author: Kerry Hatcher
doc_type: Open Records Request — Settlement Records
---

# Hatcher JH Settlement ORR

{: .note }
> **Filed** 2025-03-11 · **Filer** Kerry Hatcher (Bibb County parent) · **Addressed to** Stephanie Hartley, Chief Communications Officer, Bibb County School District · **Scope** Four-item request relating to the July 18, 2024 Student JH settlement
> **[View the PDF →]({{ site.baseurl }}/pdfs/20250311_Hatcher_ORR_JH_Settlement.pdf){: .btn .btn-outline }**
...
BCSD's response to this ORR was not a cost estimate. It was a full FERPA-based denial — the [March 14, 2025 letter from Parker Poe partner Sherry H. Culves]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/). That denial letter is the most consequential pre-litigation primary source in the record.
...
| Response | FERPA-based full denial, [March 14, 2025]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/) |
...
On **March 28, 2025**, BCSD missed its own promised production deadline for this request. On **April 10, 2025**, Parker Poe emailed Hatcher to say the district was "unable to produce any responsive documents … related to the settlement" and that it was "assessing the intersection of various federal student privacy protections, as well as confidentiality language contained within the settlement agreement itself." On **April 14, 2025**, the Georgia DOE's [response letter]({{ site.baseurl }}/documents/pre-litigation/doe-response/) to a separate parent-driven escalation redirected those parents to the AG Open Government Mediation Program — and Hatcher subsequently filed his own intake with the AG mediation program. On **April 24, 2025**, the AG's office issued its [close-out letter (AG Letter B)]({{ site.baseurl }}/documents/pre-litigation/ag-letter-closeout/) in the Corley mediation, signaling at impasse that private enforcement under [O.C.G.A. § 50-18-73(a)](https://law.justia.com/codes/georgia/2024/title-50/chapter-18/article-4/section-50-18-73/) was the remaining path.

## Read the original

**[Download the PDF →]({{ site.baseurl }}/pdfs/20250311_Hatcher_ORR_JH_Settlement.pdf)**

*Part of [Open Records Requests]({{ site.baseurl }}/documents/orr/) · Civil Action No. 2025-CV-083495 · Bibb County Superior Court*
