---
title: "Parker Poe ORR Cost Schedule"
parent: Pre-Litigation Record
grand_parent: Documents
nav_order: 5
layout: default
permalink: /documents/pre-litigation/orr-cost-schedule/
date: 2025-03-20
author: Sherry H. Culves, Partner, Parker Poe Adams & Bernstein LLP
doc_type: Cost-estimate and refusal responses (four documents)
---
...
The responses went to **three categorically distinct requester categories**, which is what makes them interesting as a record: journalist (through the open AG mediation), civic-parent (Kerry Hatcher's three March 2025 ORRs), and internal-staff (two Alex II teachers filing a February 28, 2025 ORR for personnel records on their own colleagues). BCSD's later [denial letter to Hatcher]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/) characterized this pattern as a "coordinated" records-request effort. What that characterization refers to factually is this fourteen-day, three-category window.

## The schedule

| ORR subject | Requester category | Filed | Parker Poe response | Estimate / disposition | PPAB ref | PDF |
|-------------|-------------------|-------|---------------------|-----------------------|----------|-----|
| Alex II teacher personnel records | Two Alex II teachers (internal-staff) | 2025-02-28 | 2025-03-05 | $1,590.00 (40 hrs @ $40.00/hr) — pre-payment required (>$500 threshold) | — | [Response]({{ site.baseurl }}/pdfs/20250305_BCSD_Response_Alex_II_Teachers_ORR.pdf) |
| JH Settlement records (four-item scope) | Kerry Hatcher (civic-parent) | 2025-03-11 | 2025-03-14 | Full denial on FERPA grounds — see [dedicated page]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/) | — | [Denial letter]({{ site.baseurl }}/pdfs/20250314_BCSD_Denial_Hatcher_JH.pdf) |
| LEO Calls for Service at Alex II | Kerry Hatcher (civic-parent) | 2025-03-12 | 2025-03-20 | $459.42 (10 hrs @ $47.12/hr) | 12129867v2 | [Response]({{ site.baseurl }}/pdfs/20250320_PP_Response_LEO_Calls.pdf) |
| 1st Grade Disruptions emails | Kerry Hatcher (civic-parent) | 2025-03-15 | 2025-03-20 | $153.83 (4 hrs @ $41.02/hr) | 12129772v2 | [Response]({{ site.baseurl }}/pdfs/20250320_PP_Response_1st_Grade.pdf) |
...
**3. Redactions without articulated justification.** Produced records delivered in response to these ORRs (in cases where production actually occurred) included redactions that were not accompanied by statutory citations or field-level justifications in the response letters themselves. That is a pattern observation, not a Melody case claim. Readers interested in the redaction-pattern thread can follow it at [kerryhatcher.com](https://www.kerryhatcher.com/) — it is outside the scope of the Melody litigation and this archive does not develop it further.

## Read the originals

- **[Alex II teacher ORR response (Mar. 5, 2025)]({{ site.baseurl }}/pdfs/20250305_BCSD_Response_Alex_II_Teachers_ORR.pdf)** — $1,590 cost estimate
- **[BCSD Denial Letter to Hatcher (Mar. 14, 2025)]({{ site.baseurl }}/pdfs/20250314_BCSD_Denial_Hatcher_JH.pdf)** — FERPA denial (see [dedicated page]({{ site.baseurl }}/documents/pre-litigation/bcsd-denial-hatcher/))
- **[LEO Calls for Service response (Mar. 20, 2025)]({{ site.baseurl }}/pdfs/20250320_PP_Response_LEO_Calls.pdf)** — $459.42 cost estimate
- **[1st Grade Disruptions response (Mar. 20, 2025)]({{ site.baseurl }}/pdfs/20250320_PP_Response_1st_Grade.pdf)** — $153.83 cost estimate
